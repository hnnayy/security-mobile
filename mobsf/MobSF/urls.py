...
from mobsf.DynamicAnalyzer.views.android import report as dz_report
...
if settings.API_ONLY == '0':
    urlpatterns.extend([
        ...
        re_path(
        r'^dynamic_pdf/(?P<checksum>[0-9a-f]{32})/$',
        dz_report.pdf_report,
        name='dynamic_pdf'
        ),
        re_path(fr'^dynamic_report/{checksum_regex}$',
                report.view_report,
                name='dynamic_report'),
 re_path(fr'^dynamic_pdf/{checksum_regex}/$',
        report.pdf_report,
        name='dynamic_pdf'),
        # Shared
